            ...
            <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5 sm:gap-8">
                {featuredItems.map((item) => (
                  <div
                    key={item.id}
                    className="bg-white rounded-[24px] sm:rounded-3xl overflow-hidden border border-slate-200 shadow-sm hover:shadow-lg transition-all group cursor-pointer"
                  >
                    <div className="h-52 sm:h-64 md:h-80 w-full relative overflow-hidden">
                      ...
                      {item.type === "Video" && (
                        <PlayCircle className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-16 h-16 text-white/80 group-hover:text-white transition-colors" />
                      )}
                      {item.type === "Gallery" && (
                        <ImageIcon className="absolute top-4 right-4 w-6 h-6 text-white" />
                      )}
                      {item.type === "Award" && (
                        <Trophy className="absolute top-4 right-4 w-6 h-6 text-amber-400" />
                      )}
            ...
            <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 max-w-6xl mx-auto">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-8">
                {[
                  ...
                  <div
                    key={i}
                    className="bg-white border border-slate-200 rounded-[24px] sm:rounded-3xl p-5 sm:p-8 text-center hover:shadow-xl hover:-translate-y-1 transition-all"
                  >
                    ...
                    <p className="text-purple-600 font-bold text-sm mb-4 uppercase tracking-wider">
                      {achiever.award}
                    </p>
            ...
            <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 max-w-6xl mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                {[
                  ...
                  <div
                    key={i}
                    className="bg-white border border-slate-200 rounded-3xl p-6 flex flex-col sm:flex-row gap-6 hover:shadow-lg transition-shadow"
                  >
            ...
            <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 max-w-6xl mx-auto">
              ...
              <div className="space-y-8">
                {[
                  ...
                  <div
                    key={i}
                    className="bg-white border border-slate-200 rounded-3xl overflow-hidden shadow-sm hover:shadow-lg transition-shadow flex flex-col md:flex-row"
                  >
