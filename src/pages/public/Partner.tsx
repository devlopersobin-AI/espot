            ...
            <div className="grid grid-cols-1 xl:grid-cols-[minmax(0,1fr)_380px] gap-5 sm:gap-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
              <div className="rounded-2xl border border-slate-200 bg-white p-6 sm:p-7 shadow-sm">
                <h2 className="text-2xl font-semibold text-slate-900 tracking-tight">
                  Partnership performance cockpit
                </h2>
                <p className="text-sm text-slate-600 mt-2">
                  Track how partners drive member growth, campaign conversion,
                  and retention across your core markets.
                </p>
              ...
              <div className="rounded-2xl border border-slate-200 bg-gradient-to-br from-blue-950 via-blue-900 to-cyan-900 text-white p-6 shadow-sm">
                ...
                <p className="text-sm text-cyan-100/85 mt-2 leading-relaxed">
                  Scaled preventive care campaigns to 18 cities through
                  co-branded health drives and referral programs.
                </p>
          ...
          {activeTab === "Benefits" && (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
              {[
                {
                  title: "Global Reach",
                  desc: "Access a worldwide network of members and businesses.",
                  metric: "300k+ active members",
                  icon: <Users className="w-6 h-6 text-blue-600" />,
                },
                {
                  title: "Revenue Share",
                  desc: "Earn structured commissions on transactions and campaigns.",
                  metric: "Up to 18% partner share",
                  icon: <Award className="w-6 h-6 text-blue-600" />,
                },
                {
                  title: "Brand Visibility",
                  desc: "Showcase your offers in campaigns and member moments.",
                  metric: "Avg. 2.7x CTR lift",
            ...
            <div className="bg-white border border-slate-200 rounded-2xl p-8 shadow-sm animate-in fade-in slide-in-from-bottom-4 duration-500">
              ...
              <div className="space-y-4">
                {[
                  {
                    quarter: "Q2 2026",
                    title: "Regional onboarding sprint",
                    progress: 62,
                  },
                  {
                    quarter: "Q3 2026",
                    title: "Cross-sector campaign bundles",
                    progress: 45,
                  },
                  {
                    quarter: "Q4 2026",
                    title: "Partner-led retention initiatives",
                    progress: 28,
                  },
                ].map((goal) => (
                  <div
            ...
            <div className="bg-blue-600 rounded-3xl p-8 md:p-12 text-white shadow-xl animate-in fade-in slide-in-from-bottom-4 duration-500">
              <div className="max-w-3xl">
                ...
                <p className="text-blue-100 text-lg md:text-xl mb-8">
                  Submit your profile, get scored by our partner success team,
                  and start your first campaign in as little as 14 days.
                </p>
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mb-8">
                  <div className="rounded-xl bg-white/15 border border-white/25 p-3 text-sm">
