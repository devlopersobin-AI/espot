...
export default function Home() {
  ...
  const roleHomeConfig: Record<Role, { title: string; subtitle: string; primaryAction: string; secondaryAction: string; metrics: Array<{ title: string; value: string; change: string; trend: 'up' | 'down'; icon: typeof Users }> }> = {
    Member: {
      ...
      metrics: [
        { title: 'Points Balance', value: '1,240', change: '+8.5%', trend: 'up', icon: Users },
        { title: 'Upcoming Events', value: '5', change: '+2', trend: 'up', icon: Calendar },
        { title: 'Rewards Value', value: '$320', change: '+12.0%', trend: 'up', icon: DollarSign },
        { title: 'Profile Strength', value: '78%', change: '+5.0%', trend: 'up', icon: Activity },
      ],
    },
    Partner: {
      ...
      metrics: [
        { title: 'Active Offers', value: '18', change: '+3', trend: 'up', icon: Users },
        { title: 'Partner Events', value: '9', change: '+1', trend: 'up', icon: Calendar },
        { title: 'Offer Revenue', value: '$42.8k', change: '+14.2%', trend: 'up', icon: DollarSign },
        { title: 'Lead Conversion', value: '31%', change: '+1.8%', trend: 'up', icon: Activity },
      ],
    },
    Franchisee: {
      ...
      metrics: [
        { title: 'Open Tasks', value: '14', change: '-2', trend: 'down', icon: Users },
        { title: 'Local Events', value: '4', change: '+1', trend: 'up', icon: Calendar },
        { title: 'Monthly Sales', value: '$86.2k', change: '+9.1%', trend: 'up', icon: DollarSign },
        { title: 'Service Uptime', value: '97.4%', change: '+0.4%', trend: 'up', icon: Activity },
      ],
    },
    Entrepreneur: {
      ...
      metrics: [
        { title: 'Investor Leads', value: '11', change: '+2', trend: 'up', icon: Users },
        { title: 'Pitch Events', value: '3', change: '+1', trend: 'up', icon: Calendar },
        { title: 'Committed Funds', value: '$120k', change: '+22%', trend: 'up', icon: DollarSign },
        { title: 'Product Traction', value: '64%', change: '+6.1%', trend: 'up', icon: Activity },
      ],
    },
    Leader: {
      ...
      metrics: [
        { title: 'Mentorship Sessions', value: '22', change: '+5', trend: 'up', icon: Users },
        { title: 'Leadership Events', value: '7', change: '+2', trend: 'up', icon: Calendar },
        { title: 'Funding Influence', value: '$310k', change: '+11%', trend: 'up', icon: DollarSign },
        { title: 'Team Engagement', value: '88%', change: '+1.4%', trend: 'up', icon: Activity },
      ],
    },
    Scholar: {
      title: 'Scholar Overview',
      subtitle: 'Track learning milestones, scholarships, and event participation.',
      primaryAction: 'Apply Scholarship',
      secondaryAction: 'Download Transcript',
      metrics: [
        { title: 'Learning Goals', value: '12', change: '+3', trend: 'up', icon: Users },
        { title: 'Academic Events', value: '6', change: '+1', trend: 'up', icon: Calendar },
        { title: 'Scholarship Value', value: '$7.5k', change: '+18%', trend: 'up', icon: DollarSign },
        { title: 'Course Progress', value: '82%', change: '+4.2%', trend: 'up', icon: Activity },
      ],
    },
    Jobseeker: {
      ...
      metrics: [
        { title: 'Active Applications', value: '16', change: '+4', trend: 'up', icon: Users },
        { title: 'Interview Slots', value: '3', change: '+1', trend: 'up', icon: Calendar },
        { title: 'Offer Range', value: '$2.8k', change: '+9.4%', trend: 'up', icon: DollarSign },
        { title: 'Profile Match', value: '74%', change: '+2.7%', trend: 'up', icon: Activity },
      ],
    },
    Trainer: {
      ...
      metrics: [
        { title: 'Active Batches', value: '8', change: '+2', trend: 'up', icon: Users },
        { title: 'Scheduled Classes', value: '12', change: '+3', trend: 'up', icon: Calendar },
        { title: 'Training Revenue', value: '$9.2k', change: '+13%', trend: 'up', icon: DollarSign },
        { title: 'Completion Rate', value: '91%', change: '+1.9%', trend: 'up', icon: Activity },
      ],
    },
    Admin: {
      title: 'Platform Overview',
      subtitle: 'Real-time metrics and recent activity across the E-SPOT network.',
      primaryAction: 'Create Campaign',
      secondaryAction: 'Export Report',
      metrics: [
        { title: 'Total Members', value: '24,592', change: '+12.5%', trend: 'up', icon: Users },
        { title: 'Active Events', value: '143', change: '+4.2%', trend: 'up', icon: Calendar },
        { title: 'Monthly Revenue', value: '$842.5k', change: '+18.1%', trend: 'up', icon: DollarSign },
        { title: 'Platform Engagement', value: '84.2%', change: '-2.4%', trend: 'down', icon: Activity },
      ],
    },
  };
  ...
  const recentActivity = [
    ...
    { id: 'ACT-1040', user: 'Marcus Chen', action: 'Upgraded to Diamond Tier', time: '1 hour ago', status: 'Completed' },
    { id: 'ACT-1039', user: 'Elena Rodriguez', action: 'Submitted Franchise Application', time: '3 hours ago', status: 'In Progress' },
    { id: 'ACT-1038', user: 'Growth Agency', action: 'Published new Partner Offer', time: '5 hours ago', status: 'Completed' },
  ];
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {metrics.map((metric) => (
          <div key={metric.title} className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm">
            ...
            <table className="data-grid">
              ...
              <tbody>
                {recentActivity.map((activity) => (
                  <tr key={activity.id}>
                    <td className="font-mono text-xs text-gray-500">{activity.id}</td>
                    <td className="font-medium text-gray-900">{activity.user}</td>
                    <td className="text-gray-600">{activity.action}</td>
                    <td>
                      <span className={`inline-flex items-center px-2 py-1 rounded-md text-xs font-medium ${
                        activity.status === 'Completed' ? 'bg-emerald-50 text-emerald-700 ring-1 ring-inset ring-emerald-600/20' :
                        activity.status === 'Pending Review' ? 'bg-amber-50 text-amber-700 ring-1 ring-inset ring-amber-600/20' :
