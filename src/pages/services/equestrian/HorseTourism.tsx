...
export default function HorseTourism() {
  return (
    <section className="w-full px-4 sm:px-6 lg:px-10 py-10 md:py-14 bg-white min-h-[calc(100vh-220px)]">
      <div className="max-w-5xl mx-auto space-y-6">
        ...
        <h1 className="text-3xl md:text-4xl font-black text-slate-900">Horse Tourism</h1>
        <p className="text-slate-600 text-base md:text-lg">
          Curated horse tourism packages for trail rides, countryside escapes, and destination-based riding experiences.
        </p>
        <div className="bg-slate-50 border border-slate-200 rounded-xl p-5">
          <h2 className="text-lg font-bold text-slate-900 mb-2">What this includes</h2>
          <ul className="list-disc pl-5 text-slate-600 space-y-1">
            <li>Local and destination horse tour itineraries</li>
            <li>Group and private booking support</li>
            <li>Travel-safe horses with guided routes</li>
          </ul>
        </div>
