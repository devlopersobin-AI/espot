...
export default function HorseShow() {
  return (
    <section className="w-full px-4 sm:px-6 lg:px-10 py-10 md:py-14 bg-white min-h-[calc(100vh-220px)]">
      <div className="max-w-5xl mx-auto space-y-6">
        ...
        <h1 className="text-3xl md:text-4xl font-black text-slate-900">Horse Show</h1>
        <p className="text-slate-600 text-base md:text-lg">
          Participate in or host horse shows featuring breed presentation, parade classes, and judged showcase events.
        </p>
        <div className="bg-slate-50 border border-slate-200 rounded-xl p-5">
          <h2 className="text-lg font-bold text-slate-900 mb-2">What this includes</h2>
          <ul className="list-disc pl-5 text-slate-600 space-y-1">
            <li>Event registration and participant onboarding</li>
            <li>Showcase categories and judging criteria</li>
            <li>Vendor and audience access planning</li>
          </ul>
        </div>
