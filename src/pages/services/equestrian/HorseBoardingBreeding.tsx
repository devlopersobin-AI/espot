...
export default function HorseBoardingBreeding() {
  return (
    <section className="w-full px-4 sm:px-6 lg:px-10 py-10 md:py-14 bg-white min-h-[calc(100vh-220px)]">
      <div className="max-w-5xl mx-auto space-y-6">
        ...
        <h1 className="text-3xl md:text-4xl font-black text-slate-900">Horse Boarding &amp; Breeding</h1>
        <p className="text-slate-600 text-base md:text-lg">
          Professional horse boarding and responsible breeding support with nutrition, shelter, and veterinary oversight.
        </p>
        <div className="bg-slate-50 border border-slate-200 rounded-xl p-5">
          <h2 className="text-lg font-bold text-slate-900 mb-2">What this includes</h2>
          <ul className="list-disc pl-5 text-slate-600 space-y-1">
            <li>Short and long-term boarding plans</li>
            <li>Stud selection and breeding consultations</li>
            <li>Foal care and health monitoring services</li>
          </ul>
        </div>
