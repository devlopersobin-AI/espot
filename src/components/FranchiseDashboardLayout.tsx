...
const SIDEBAR_NAV = [
  { name: 'Overview', path: '/dashboard/franchise', icon: LayoutDashboard },
  { name: 'Franchise Profile', path: '/dashboard/franchise/profile', icon: Building2 },
  { name: 'Events', path: '/dashboard/franchise/events', icon: Calendar },
];
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-[#F7F7F8] font-sans text-gray-900">
      ...
      <aside className="w-64 bg-white border-r border-gray-200 flex flex-col shrink-0 z-20">
        <div className="h-16 flex items-center px-6 border-b border-gray-200 font-bold text-xl tracking-tight">Franchise</div>
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        <header className="h-16 bg-white border-b border-gray-200 flex items-center px-8 shrink-0 z-10">
          <h1 className="text-lg font-semibold text-blue-700">Franchise Dashboard</h1>
        </header>
