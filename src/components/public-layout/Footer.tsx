        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3 text-slate-400 text-sm">
              <li><Link to="/partner" className="hover:text-white transition-colors">Become a Partner</Link></li>
              <li><Link to="/franchise" className="hover:text-white transition-colors">Own a Franchise</Link></li>
              <li><Link to="/membership" className="hover:text-white transition-colors">Get Membership</Link></li>
              <li><Link to="/investment" className="hover:text-white transition-colors">Invest with Us</Link></li>
            </ul>
          </div>
          <div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-slate-400 text-sm">
              ...
              <li><Link to="/membership" className="hover:text-white transition-colors">Membership Terms</Link></li>
              <li><Link to="/auth" className="hover:text-white transition-colors">Account Policy</Link></li>
            </ul>
          </div>
        </div>
